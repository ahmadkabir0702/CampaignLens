...
const tools = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        content_intent: { type: 'string', enum: ['educate','entertain','demonstrate','prove','announce','inspire','promote_offer'] },
        narrative_structure: { type: 'string', enum: ['problem_solution','story','tips','demo','montage','testimonial_arc','performance'] },
        hook_device: { type: 'string', enum: ['question','bold_claim','problem','product_reveal','face_to_camera','motion','text_overlay','sound','before_after','unexpected_visual'] },
